...
export function CreateTokenPage({ onBack, onCreated }: CreateTokenPageProps) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      console.log('✅ Token creado:', result.tokenAddress);
      
      // Autorizar TokenExchange como minter para que los usuarios puedan comprar tokens
      ...
      // También autorizar PredictionMarket para que se puedan usar tokens en apuestas
      ...
      <div className="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6 space-y-6">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Ej: IBAI"
            maxLength={10}
            className="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:border-emerald-500 focus:outline-none uppercase"
          />
