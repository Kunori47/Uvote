    ...
    components: {
        securitySchemes: {
            WalletSignature: {
                ...
                description: 'Token basado en firma de wallet. Contiene { message, signature, address } en Base64.',
            },
        },
    },
    security: [
                            ...
                            schema: {
                                ...
                                properties: {
                                    ...
                                    type: {
                                        ...
                                        description: "Tipo de imagen: 'profile' para avatar de usuario, 'moneda' para imagen de token, 'prediction' para imagen de predicción",
                                    },
                                },
                                required: ['image'],
                            },
